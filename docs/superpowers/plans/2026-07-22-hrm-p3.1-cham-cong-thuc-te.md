...
### Task 9: Ba service FE + helper đọc mã lỗi thiết bị
...
- Produces: `holidayService`, `employeeDeviceService`, `attendanceRecordService`, và `maLoiChamCong(err: unknown): string | undefined` — Task 12 dùng để chọn màn hình theo mã lỗi.

- [ ] **Step 1: Viết `holidayService`**
...
- [ ] **Step 2: Viết `employeeDeviceService`**
...
- [ ] **Step 3: Viết test thất bại cho `maLoiChamCong`**
...
- [ ] **Step 5: Viết `attendanceRecordService`**
...
```bash
git add fe/src/services/holidayService.ts \
...
git commit -m "feat(fe): service ngày lễ, thiết bị, bản ghi chấm công + đọc mã lỗi thiết bị"
```
...
const DINH_DANG_NGAY = "YYYY-MM-DD";
